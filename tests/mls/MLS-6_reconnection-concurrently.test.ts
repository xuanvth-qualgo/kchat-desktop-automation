...
const TESTCASE_STEPS = [
   ...
   '3. Member1, Member2, Member3: quit app concurrently',
   '4. Owner, Admin1, Admin2, Member4: send 1 message concurrently',
   '5. Member1, Member2, Member3: reopen app concurrently',
...
const TESTCASE_NAME = `Quit app and reopen app concurrently`;

const text = 'test MLS';
const GROUP = { name: GROUP_REF[2].name };

test.describe('[MLS Group][Quit App --> Reopen App concurrently]', () => {
